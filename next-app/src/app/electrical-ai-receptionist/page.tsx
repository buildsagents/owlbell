...
const vertical = getVertical("electrical");
const SITE_URL = "https://owlbell.xyz";

export const metadata: Metadata = {
  title: "AI Receptionist for Electricians — 24/7 Answering | Owlbell",
  description: vertical.subhead,
  alternates: { canonical: `${SITE_URL}${vertical.path}` },
};

export default function ElectricalAiReceptionistPage() {
