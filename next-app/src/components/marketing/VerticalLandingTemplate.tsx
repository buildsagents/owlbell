  ...
  return (
    <div className="site">
      ...
      <main className="site-main">
        <section className="hero-dispatch" id="top">
          <div className="hero-dispatch-grid wrap">
            <div className="hero-dispatch-copy">
              <p className="kicker">{vertical.trade} · Self-serve setup in under 15 minutes</p>
              <h1>
                {vertical.headline}
              </h1>
              <p className="hero-dispatch-lead">{vertical.subhead}</p>
              <div className="hero-dispatch-actions">
                <Link href={onboardingHref({ vertical: vertical.slug })} className="btn btn--copper">
                  {CTA_LAUNCH_AI}
                </Link>
        ...
        <section className="section">
          <div className="wrap">
            <header className="section-lead">
              ...
              <h2>Scripts and routing tuned for your trade</h2>
            </header>
        ...
        <RoiCalculator defaultVertical={vertical.slug} />
        <section className="section section--warm">
          <div className="wrap case-study-cta">
            <p>Ready to stop sending leads to voicemail?</p>
            <Link href={onboardingHref({ vertical: vertical.slug, source: "vertical_cta" })} className="btn btn--copper">
              {CTA_START_TRIAL}
            </Link>
          </div>
        </section>
