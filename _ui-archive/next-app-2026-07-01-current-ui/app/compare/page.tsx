...
const OPTIONS = [
  ...
  {
    name: "Owlbell",
    cost: "3-5 booked jobs/mo pays for Launch - managed setup",
    pros: "24/7 answering, booking, CRM handoff, live dashboard, we configure everything",
...
export default function ComparePage() {
  return (
    <TrustPage title="Compare your options" meta="Cost per booked job - not cost per minute">
      ...
      <section>
        <Link href={auditHref({ source: "compare" })} className="btn btn--copper">
          {CTA_PRIMARY}
        </Link>
      </section>
    </TrustPage>
