...
async def main() -> None:
    ...
    parser.add_argument("--mode", choices=["initial", "followup", "stats"], default="initial",
                        help="'initial' = scrape+email new leads, 'followup' = send follow-ups, 'stats' = show stats")
    parser.add_argument("--trades", default="hvac,plumbing,roofing,electrical", help="Comma-separated trades")
