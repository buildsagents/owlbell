...
class AIBaseTask(Task):
    ...
    def on_failure(self, exc, task_id, args, kwargs, einfo):
        ...
        if call_id:
            try:
                from legacy.orchestrator.event_bus import EventBus
...
def ai_stt(
    ...
    try:
        from legacy.orchestrator.models import CallState
        from legacy.orchestrator.session_manager import SessionManager
...
def ai_llm(
    ...
    """
    from legacy.orchestrator.circuit_breaker import get_circuit_breaker
    from legacy.orchestrator.models import CallState
    from legacy.orchestrator.session_manager import SessionManager
...
def ai_pipeline(
    ...
    try:
        from legacy.orchestrator.event_bus import EventBus
        from legacy.orchestrator.models import CallState, EventType, SystemEvent
        from legacy.orchestrator.session_manager import SessionManager
