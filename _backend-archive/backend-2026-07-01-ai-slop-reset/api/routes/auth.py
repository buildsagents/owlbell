...
from api.dependencies import CurrentUser, DBSession, get_current_user
...
async def _register_and_get_tokens(
    ...
    from backend.db.models.enums import PlanTier, TenantStatus, UserRole
...
async def register(
    ...
    return await _register_and_get_tokens(body, request, db)
